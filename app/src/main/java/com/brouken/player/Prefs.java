...
class Prefs {
    ...
    // Removed product setting: UA Player always translates into Ukrainian.
    private static final String PREF_KEY_LANGUAGE_SUBTITLE_TRANSLATE = "languageSubtitleTranslate";
