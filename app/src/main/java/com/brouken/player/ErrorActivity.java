...
public class ErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (title != null) {
            ...
            // failure that did not happen; the app icon keeps the halo without the alarm.
            ((ImageView) findViewById(R.id.errorIcon)).setImageResource(R.drawable.ua_player_icon);
        }
    ...
    private void copy(final String text) {
        ...
        if (cm != null) {
            cm.setPrimaryClip(ClipData.newPlainText("UA Player error", text));
